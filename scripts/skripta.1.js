...
function updateCharacter(x, y, z) {
    character.x = x;
    character.y = y;
    character.z = z;
    character.xRangeLeft = x - 0.3;
    character.xRangeRight = x + 0.3;
    character.zRangeLeft = z - 0.3;
    character.zRangeRight = z + 0.3;
...
function collisionDetection() {
    console.log(-character.xRangeLeft, -character.xRangeRight);
    if (character.xRangeRight < 0 && character.xRangeLeft > 1) {
